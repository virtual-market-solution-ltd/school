        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 m-b-30 header-title">Desgination Entry</h4>
                        ...
                        @endif
                        <form action="{{ route('hr.designation') }}" method="post">
                            @csrf
                        ...
                        <hr>
                        <br>
                        <h4 class="mt-0 m-b-30 header-title">Designation List</h4>
                        <hr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <input class="form-control" type="text" name="designation" value="{!! $row->designation !!}" required>
                                                                        </td>
                                                                        <td>
