        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 m-b-30 header-title">Desgination Group Entry</h4>
                        ...
                        @endif
                        <form action="{{ route('hr.designationgroup') }}" method="post">
                            @csrf
                        ...
                        <hr>
                        <br>
                        <h4 class="mt-0 m-b-30 header-title">Designation Group List</h4>
                        <hr>
