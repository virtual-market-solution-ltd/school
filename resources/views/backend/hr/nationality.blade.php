        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 m-b-30 header-title">Nationality Entry</h4>
                        ...
                        @endif
                        <form action="{{ route('hr.nationality') }}" method="post">
                            @csrf
                        ...
                        <hr>
                        <br>
                        <h4 class="mt-0 m-b-30 header-title">Nationality List</h4>
                        <hr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <input class="form-control" type="text" name="nationality" value="{!! $row->nationality !!}" required>
                                                                        </td>
                                                                        <td>
